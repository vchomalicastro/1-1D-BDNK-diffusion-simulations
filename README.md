...
SA-PINN-ACTO (physics-informed neural network) and KT (Kurganov-Tadmor) simulations of BDNK diffusion in (1+1)D, as used in "Solving BDNK diffusion using physics-informed neural networks" (Chomalí-Castro, Clarisse, Mullins, Noronha, 2026).
